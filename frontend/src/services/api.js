...
export const timeOffAPI = {
  ...
  approve: (id, data) => api.put(`/timeoff/${id}/review`, { status: 'approved', reviewNotes: data?.comment }),
  reject: (id, data) => api.put(`/timeoff/${id}/review`, { status: 'rejected', reviewNotes: data?.comment }),
